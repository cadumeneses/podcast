...
import 'package:podcast/app/util/custom_color.dart';
                ...
                child: SizedBox(
                  ...
                  child: SingleChildScrollView(
                    child: Column(children: [
                      const SizedBox(height: 20),
                      PodcastWidget(
                        img: "assets/imgs/philips.jpg",
                        title: "Lorem Ipsum",
                        description: "blblblblblblblblblblblblbll",
                        click: () {
                          setState(() {
                            isplaying = !isplaying;
                          });
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: const DecorationImage(
                                        image: AssetImage("asset/philips.jpg"),
                                        fit: BoxFit.cover)),
                              ),
...
class CategoryWidget extends StatelessWidget {
  const CategoryWidget({Key? key, required this.text, required this.color})
      : super(key: key);
